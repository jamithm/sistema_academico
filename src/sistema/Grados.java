...
public class Grados extends javax.swing.JInternalFrame {
    ...
    void TamañoTabla(){
        ...
        column = tblGrados.getColumnModel().getColumn(0);
        column.setPreferredWidth(78);
        column = tblGrados.getColumnModel().getColumn(1);
    ...
    void CargarTabla(String valor){
        ...
        String sSQL = "";
        sSQL = "SELECT * FROM grados WHERE denominacion LIKE '%"+valor+"%'";
    ...
    void CargarDatos(String id){
        ...
        sSQL = "SELECT * FROM grados WHERE id = " + id;
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtGrado, javax.swing.GroupLayout.DEFAULT_SIZE, 294, Short.MAX_VALUE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(accion.equals("Insertar")){
            sSQL = "INSERT INTO grados (denominacion) VALUES(?)";
            mensaje = "Registro Guardado...!";
        } else if(accion.equals("Modificar")){
            sSQL = "UPDATE grados SET denominacion = ? WHERE id = " + id_act;
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (txtCodigo.getText().equals("")){
            ...
            if (opcion == 0){
                ...
                try{
                    PreparedStatement pst = cn.prepareStatement("DELETE FROM grados WHERE id = ?");
    ...
    private void tblGradosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblGradosMouseClicked
        ...
        try {
            filasel = tblGrados.getSelectedRow();
            if(filasel == -1) {
                JOptionPane.showMessageDialog(null, "No se ha seleccionado ninguna fila...!");
            } else {
                modelo = (DefaultTableModel) tblGrados.getModel();
